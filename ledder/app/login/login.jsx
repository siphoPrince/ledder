  ...
  return (
    <>
      <div className="flex min-h-screen flex-col items-center justify-center bg-gray-100 p-4">
        {/* Welcome Section - Now on top */}
        <div className="mb-8 w-full max-w-lg rounded-2xl bg-green-300 p-8 text-center text-white shadow-lg md:max-w-xl">
        ...
        <form className="w-full max-w-lg rounded-2xl bg-white p-8 shadow-lg md:max-w-xl">
          ...
          <button
            type="submit"
            className="mt-6 w-full rounded-2xl bg-green-600 p-2 text-white transition duration-300 hover:bg-green-700"
          >
            Sign In
          </button>
        </form>
